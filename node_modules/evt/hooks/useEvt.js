...
function useEvt(factoryOrEffect, deps) {
    var _a = __read(react_1.useState(function () { return lib_1.Evt.newCtx(); }), 1), ctx = _a[0];
    var out = react_1.useMemo(function () {
        ctx.done();
        return factoryOrEffect(ctx);
    }, deps);
    react_1.useEffect(function () { return function () { ctx.done(); }; }, []);
...
function useHackStrictMode(isDevStrictMode, ctx) {
    ...
    react_1.useState(function () {
        ...
        timer = safeSetTimeout_1.safeSetTimeout(function () { return ctx.done(); }, 100);
    });
