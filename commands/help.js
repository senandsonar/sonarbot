...
const exampleEmbed = new Discord.MessageEmbed()
	.setColor('RANDOM')
	.setTitle('**Do ",setup" to use Mirai to her max potential!**')
	...
	.addFields(
		...
		{ name: '**Miscellaneous**', value: 'status | weather | spotify | number | report | corona/covid | roleinfo | poll | 8ball | av | ping | help | setup | invite | emoji | giveaway | background | quickhelp', inline: true },
