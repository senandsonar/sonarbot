...
module.exports={
    ...
    run: async(bot,message,args)=>{
        if(!message.member.permissions.has("SEND_MESSAGES"))return message.channel.send(`For some reason you do not have sufficient permissions to use this command, ${message.author.username}`)
